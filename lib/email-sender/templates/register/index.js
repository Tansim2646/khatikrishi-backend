    ...
    <div style="background-color:#f2f3f8; padding-bottom:100px;">
      ...
      >
        ...
        <p style="margin-bottom:20px;">Click this link for active your account</p></p>
                             ...
                             <a href=${process.env.STORE_URL}/email-verification/${option.token} style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verify Account</a>
